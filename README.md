...
## 🆕 Neural Engine Discovery & Auto-Optimization

**New in this version**: Automatic Neural Engine detection and optimization for iPad Pro M4, M3, M2, M1 and all A-series chips!

```bash
# Discover your device's Neural Engine capabilities
swift run StableDiffusionSample discover

# Generate with auto-optimized settings for your device
swift run StableDiffusionSample generate "a beautiful sunset" \
  --resource-path ./models \
  --auto-optimize
```

📖 **[Read the Neural Engine Guide](NEURAL_ENGINE_GUIDE.md)** for complete documentation on:
- iPad Pro M4 specific optimizations (38 TOPS Neural Engine!)
- Automatic device detection (M4, M3, M2, M1, A17 Pro, A16, A15, A14)
...
- `NeuralEngineDiscovery`, a new module for automatic device detection and optimization
...
| --------------------- | --------------- | ---------------------------- | ---------------------- | ------------------------ |
| **iPad Pro (M4)** 🆕  | `CPU_AND_NE`    |      `SPLIT_EINSUM_V2`       |      **5.0**⚡         |        **4.00**          |
