...
- `SafariSiriExtension`, a Safari extension with Siri integration that uses Core ML to provide intelligent web search assistance by highlighting relevant content based on your machine learning profile. See the [SafariSiri Extension section](#safarisiri-extension) for details.
...
## <a name="safarisiri-extension"></a> SafariSiri Extension Orb Application

<details>
  <summary> Click to expand </summary>

The SafariSiri Extension is a powerful Safari extension that integrates with Siri to provide ML-powered web search assistance. It automatically highlights relevant and engaging content based on your personalized machine learning profile.

### Features

- **🎯 Intelligent Content Highlighting**: Automatically highlights relevant content on web pages based on your ML profile
- **🗣️ Siri Integration**: Voice-activated search assistance and content highlighting
- **🧠 Machine Learning Profile**: Personalized content filtering based on your interests
- **⚡ Real-time Analysis**: Uses Core ML for fast, on-device content analysis
...
4. **Use with Siri**:
   ...
   - "Hey Siri, help me with my search"

### Components

- **SafariExtensionHandler.swift**: Main extension handler and ML profile management
- **SiriIntentHandler.swift**: Siri intent processing and voice command handling
- **ContentAnalyzer.swift**: Core ML content analysis and NLP
- **content.js**: Web page content script for highlighting

### Documentation

- [SafariSiri Extension README](swift/SafariSiriExtension/README.md) - Complete feature documentation
- [Integration Guide](swift/SafariSiriExtension/INTEGRATION_GUIDE.md) - Detailed integration instructions
- [Example Code](swift/SafariSiriExtension/SafariSiriExtensionExample.swift) - Usage examples

### Privacy

All ML processing happens on-device using Core ML. No data is sent to external servers. Your ML profile is stored locally using UserDefaults.
